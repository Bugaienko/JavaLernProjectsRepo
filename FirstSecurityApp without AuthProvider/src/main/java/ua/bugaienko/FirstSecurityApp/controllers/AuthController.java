...
import ua.bugaienko.FirstSecurityApp.util.PersonValidator;
...
public class AuthController {
    ...
    public String createRegistration(@ModelAttribute("person") @Valid Person person, BindingResult bindingResult){
